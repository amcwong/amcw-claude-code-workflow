...
- **Chapters:** `lectures/weekNN.qmd` (source of truth). Optional practice: `lectures/weekNN-practice.qmd`, generated by `/course-notes practice <slug> <N>`. Do not keep a parallel week markdown file.
